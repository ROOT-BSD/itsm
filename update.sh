...
#   10. Видаляє застарілий кеш метрик шрифтів PDF-звітів (якщо він містить шлях з іншого сервера)
#   11. Перевстановлює права доступу на файли для веб-сервера
#
...
# ---------- 10. Очищення застарілого кешу PDF-шрифтів ----------
section "10. Очищення кешу метрик шрифтів PDF-звітів"
...
# ---------- 11. Права доступу ----------
section "11. Права доступу до файлів"
