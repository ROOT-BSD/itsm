...
#   6. Видаляє застарілий кеш метрик шрифтів PDF-звітів (якщо він містить шлях з іншого сервера)
#   7. Перевстановлює права доступу на файли для веб-сервера
#
...
# ---------- 6. Очищення застарілого кешу PDF-шрифтів ----------
section "6. Очищення кешу метрик шрифтів PDF-звітів"
...
# ---------- 7. Права доступу ----------
section "7. Права доступу до файлів"
